...
from reportlab.lib.styles import TA_CENTER, ParagraphStyle, getSampleStyleSheet
...
class Test(object):
    ...
    def run(self):
        ...
        Run the report
        """
        self.doc = SimpleDocTemplate("test_static_flowable.pdf")
    ...
    def createLineItems(self):
        ...
        for x in range(200):
            line_data = [str(line_num), "04/12/2013", "73090", "Test Reflexes", "1", "131.00", "0.00", "0.00", "0.00", "0.00", "1234"]
        ...
        table = Table(data, colWidths=[20, 40, 45, 120, 30, 40, 50, 50, 50, 50, 30])
